        ...
        <ul class="author-page white-path">
          ...
          <li class="dropdown">
            <a
              ...
              aria-expanded="false"
            >
              <img class="user-thumb" src="~assets/images/profile.png" alt="Neba funwi-gabga" />
              <div class="usr-info">
                <span class="user-name font-14 fw-500" v-if="$auth.loggedIn">
                  {{authname}}
                </span>
...
export default {
   ...
   methods:{
      ...
      mounted(){
         ...
         this.authname=this.$auth.user.name;
      }
     }
};
</script>
